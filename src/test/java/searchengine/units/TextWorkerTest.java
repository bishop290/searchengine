...
class TextWorkerTest {
    ...
    void testSnippets() {
        String expect = "...но  никак  некомментирует.     Зачем ему говорить о гоми? Это его  среда обитания, воздух,  которым ондышит.  Всю свою жизнь он плавает в гоми как рыба в воде.  Рубин мотается поокруге в  своем  грузовике-развалюхе,  переделанном из древнего аэродромного\"мерседеса\", крышу которого  закрывает огромны...<br><br>...стья и блестящее пятно наруке,  где экзоскелет натер кожу. Я тогда был  слишком  пьян, чтобы все  этопонять, но все же сообразил: что-то здесь не то.  И  я поступил  точь-в-точьтак, как  люди  обычно  поступают  с Лайзой: переключился  \"на другое кино\".Вместо  пива  направился к винным  бутылкам, чт...<br><br>";
